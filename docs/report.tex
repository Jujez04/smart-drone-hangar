...
\begin{enumerate}
    \item \textbf{Drone Hangar (Arduino)}: \tobefilled{Descrivi brevemente cosa fa la parte Arduino.}
    \item \textbf{Drone Remote Unit (PC)}: \tobefilled{Descrivi brevemente cosa fa la GUI Java.}
\end{enumerate}

\subsection{Componenti usate}
Il sistema utilizza le seguenti componenti hardware:
\begin{itemize}
    \item \textbf{Sensors}: \tobefilled{Elenca i sensori (es. HC-SR04, PIR, TMP36...)}
    \item \textbf{Actuators}: \tobefilled{Elenca gli attuatori (es. Servo Motor, LEDs...)}
\end{itemize}
...
\subsection{Protocollo di Communicazione}
La communicazione avviene a \textbf{9600 baud}.
